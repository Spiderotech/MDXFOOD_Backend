...
const Register = () => {
    ...
    const formikStep3 = useFormik({
        ...
        onSubmit:async (values) => {
            ...
            if (!fileimg) {
                formikStep3.setFieldError('coverPhoto', 'Image is required');
            }
                    ...
                    .then((response) => {
                        if (response.data.status === true) {
                            ...
                            localStorage.setItem("access_token_admin", response.data.accessToken);
                              ...
                              dispatch(
                                login({
                                  id: response.data.isRestaurant.userId,
                                  email: response.data.isRestaurant.userEmail,
    ...
    const handleImageChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        formikStep3.setFieldValue('coverPhoto', file || null);
    };
    ...
    return (
        <>
            <div className="bg-indigo-50 w-screen h-screen">
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9   flex items-center justify-center">
                    ...
                    {step === 1 && (
                        <>
                            ...
                            <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-1/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6  ">
                                ...
                                <form onSubmit={formikStep1.handleSubmit}>
                                    <div className="mt-6 w-full">
                                        ...
                                        {formikStep1.touched.email && formikStep1.errors.email && (
                                            <div className='text-red-500 text-[12px] absolute mt-2'>{formikStep1.errors.email}</div>
                                        )}
                                    </div>
                                    <div className="mt-6 w-full">
                                        ...
                                        {formikStep1.touched.password && formikStep1.errors.password && (
                                            <div className='text-red-500 text-[12px] absolute mt-2'>{formikStep1.errors.password}</div>
                                        )}
                                    </div>
                                    <div className="mt-6 w-full">
                                        <label htmlFor="myInput" className="text-sm font-medium leading-none text-gray-800">
                                        ...
                                        {formikStep1.touched.confirmPassword && formikStep1.errors.confirmPassword && (
                                            <div className='text-red-500 text-[12px] absolute mt-2'>{formikStep1.errors.confirmPassword}</div>
                                        )}
                                    </div>
                                    <div className="mt-8">
                    ...
                    {step === 2 && (
                        <>
                            ...
                            <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-1/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6  mt-40">
                                <p tabIndex={0} className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800">
                                    Otp Verification
                                </p>
                                <p tabIndex={0} className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
                                    Enter the code we've sent via mail to{" "}
                                    <a href="/" className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none text-gray-800 cursor-pointer">
                                        {" "}
                            ...
                            <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-1/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                                ...
                                <form onSubmit={formikStep3.handleSubmit}>
                                    <div className="mt-2 w-full">
                                        <label htmlFor="restaurantName" className="text-sm font-medium leading-none text-gray-800">
                                            Name of Restaurant
                                        </label>
                                        <input
                                            type="text"
                                            id="restaurantName"
                                            name="restaurantName"
                                            value={formikStep3.values.restaurantName}
                                            onChange={formikStep3.handleChange}
                                            onBlur={formikStep3.handleBlur}
                                            className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2"
                                            placeholder="e.g: Restaurant Name"
                                        />
                                        {formikStep3.touched.restaurantName && formikStep3.errors.restaurantName && (
                                            <div className='text-red-500 text-sm absolute mt-2'>{formikStep3.errors.restaurantName}</div>
                                        )}
                                    ...
                                    <div className="mt-6 w-full">
                                        ...
                                        <input
                                            ...
                                            id="location"
                                            name="location"
                                            value={formikStep3.values.location}
                                            onChange={formikStep3.handleChange}
                                            onBlur={formikStep3.handleBlur}
                                            className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2"
                                            placeholder="e.g: Restaurant Location"
                                        />
                                        {formikStep3.touched.location && formikStep3.errors.location && (
                                            <div className='text-red-500 text-sm absolute mt-2'>{formikStep3.errors.location}</div>
                                        )}
                                    </div>
                                    <div className="mt-6 w-full">
                                        <label htmlFor="coverPhoto" className="text-sm font-medium leading-none text-gray-800">
                                            Cover Photo
                                        </label>
                                        <input
                                            id="coverPhoto"
                                            ...
                                            className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2"
                                        />
                                        {formikStep3.touched.coverPhoto && formikStep3.errors.coverPhoto && (
                                            <div className="text-red-500 text-sm">{formikStep3.errors.coverPhoto}</div>
                                        )}
                                    </div>
                                    <div className="mt-8">
                                        <button type="submit" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">
