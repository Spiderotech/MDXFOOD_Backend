...
const Itemaddform = () => {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            price: '',
            preparationTime: '',
            extraItems: Array.from({ length: 2 }, () => ({ name: '', price: '' })),
        },
                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className="space-y-12">
                        <div className="border-b border-gray-900/10 pb-12">
                            <h2 className="text-base font-semibold leading-7 text-gray-900">Add Your food items</h2>
